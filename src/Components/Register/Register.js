        ...
        <Box className={useTheme.formBase}>
            <FormGroup className={useTheme.formMain}>
                ...
                <Box component='div' className={useTheme.TPButtons}>
                    <Button className={useTheme.iconsButton} endIcon={<GitHub />}>Sign In with GitHub</Button>
                    <Button className={useTheme.iconsButton} endIcon={<Facebook />}>Sign In with Facebook</Button>
